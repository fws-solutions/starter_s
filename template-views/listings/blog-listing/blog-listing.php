...
<div class="blog-listing">
    <div class="container">
        <div class="blog-listing__head">
            <h1 class="blog-listing__title section-title"><?php echo esc_html($title) ?></h1>
            <?php if ($subtitle) : ?>
                <div class="blog-listing__desc"><?php echo esc_html($subtitle); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="row">
            ...
            if (have_posts()) {
                ...
                <div class="col-sm-12">
                    ...
                    <a class="btn js-load-more" href="javascript:;"><?php echo esc_html__('Load More', 'fws_starter_s'); ?></a>
                </div>
                <?php
            } else {
