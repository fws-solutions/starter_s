        ...
        <main id="main" class="site-main">
            <div class="styleguide">
                <div class="styleguide__scrollspy-nav js-styleguide-nav-wrap">
                    ...
                    <a href="javascript:;" class="styleguide__scrollspy-nav-open js-styleguide-open">
                        <?php echo wp_kses_post(fws()->render()->inlineSVG('ico-arrow-right', 'styleguide-open-icon')); ?>
                    </a>
                </div>
