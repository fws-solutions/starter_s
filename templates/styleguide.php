		...
		<main id="main" class="site-main">
			<div class="styleguide">
				...
				<div class="styleguide-holder">
					...
					<!-- <div class="styleguide__scrollspy-nav js-styleguide-nav-wrap">
						<div class="styleguide-nav-list-holder js-styleguide-nav-list-holder ps">
							<ul class="styleguide__scrollspy-nav-list js-styleguide-nav">
								<li>
									<a class="list-group-item active" href="#section-0">Colors</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-1">Container</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-2">Fonts</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-3">Buttons</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-4">Form elements</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-5">Icons</a>
								</li>

								<li>
									<a class="list-group-item" href="#section-6">Popup</a>
								</li>
							</ul>
						</div>
					</div> -->
					<div class="container">
						...
						<div id="section-1" data-section-title="Container" class="styleguide__section js-styleguide-section">
							<div class="styleguide__section-content">
								<div class="styleguide__section-inner">
									<div class="row">
										<div class="col-md-2">
						...
						<div id="section-2" data-section-title="Fonts" class="styleguide__section js-styleguide-section">
							<div class="styleguide__section-content">
								...
								<span class="styleguide-component__border">Fonts/Titles</span>
							</div>
						</div>
