<?php
/**
 * fws_starter_s functions and definitions
 *
...
if ( !function_exists( 'fws_starter_s_setup' ) ) :
	/**
...
add_action( 'after_setup_theme', 'fws_starter_s_setup' );
 ...
 */
function fws_starter_s_content_width() {
...
add_action( 'after_setup_theme', 'fws_starter_s_content_width', 0 );
 ...
 */
function fws_starter_s_widgets_init() {
...
add_action( 'widgets_init', 'fws_starter_s_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function fws_starter_s_scripts() {
	...
	wp_enqueue_script( 'fws_starter_s-site-js', get_template_directory_uri() . '/dist/site.min.js', array(), '', true );
