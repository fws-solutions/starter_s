			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'starter_s' ); ?></h2>
						<ul>
						<?php
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'starter_s' ), convert_smilies( ':)' ) ) . '</p>';
