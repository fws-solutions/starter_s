...
<head>
    ...
    <link rel="preload" href="<?php echo esc_url(get_template_directory_uri()); ?>/src/assets/fonts/OpenSans-Bold.woff2"
          as="font" crossorigin/>
    <link rel="preload" href="<?php echo esc_url(get_template_directory_uri()); ?>/src/assets/fonts/OpenSans-Regular.woff2"
          as="font" crossorigin/>
                ...
                <div class="site-header__branding">
                    <a class="site-header__logo" href="<?php echo esc_url(home_url('/')); ?>" rel="home">
                        <img class="site-header__logo-img"
                             src="<?php echo wp_kses_post(fws()->images()->assetsSrc('logo-white.png')); ?>"
                             alt="<?php bloginfo('name'); ?> Logo" title="<?php bloginfo('name'); ?>">
                    </a>
                </div>
