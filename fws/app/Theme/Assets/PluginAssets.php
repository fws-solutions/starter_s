...
class PluginAssets extends SingletonHook
{
     ...
     * @return void
     */
    private function pluginWooCommerceFonts(): void  // @phpstan-ignore-line  -- placeholder function
    {
    ...
    private function pluginCF7(): void
    {
        ...
        /**
         * TODO: Set conditional logic to detect only pages that have CF7 shortcode on them.
         */
        $currentPageContainsCF7 = true;

        // deregister assets
        if (!$currentPageContainsCF7) {  // @phpstan-ignore-line
