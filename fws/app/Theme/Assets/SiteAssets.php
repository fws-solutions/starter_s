...
class SiteAssets extends SingletonHook
{
    ...
    protected function __construct()
    {
        ...
        $this->localizedObjectName = 'fwsLocalized';
        $this->localizedObjectValues = [
            'themeRoot' => get_template_directory_uri(),
            'siteUrl' => esc_url(home_url('/')),
            'ajaxUrl' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce(fws()->render()->localizedNonceAction()),
        ];
    }
    ...
    public function moveAllScriptsToHeader(): void
    {
        ...
        add_action('wp_head', 'wp_print_scripts', 5); // @phpstan-ignore-line
        add_action('wp_head', 'wp_print_head_scripts', 5); // @phpstan-ignore-line
