...
class WPLogin extends SingletonHook
{
    ...
    public function editLoginFooter(): void
    {
        ...
        $html .= sprintf(
            '<div class="fws-footer-author"><span>%s<a href="%s" target="_blank" rel="noopener">Forwardslash</a></span></div>',
            __('Powered by ', 'fws_starter_s'),
            esc_url('http://fws.us/')
        );
     ...
     * Add login title
     */
    public function addLoginTitle(mixed $message): string
    {
        $newHtml = '';
     ...
     * Edit login footer
     */
    public function editLoginFooterLink(string $html): string
    {
