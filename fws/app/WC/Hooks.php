...
class Hooks extends Singleton
{
    ...
    protected function __construct()
    {
        ...
        add_filter('woocommerce_form_field', [$this, 'changeCheckoutMarkup'], 10, 4);
     ...
     * @return string
     */
    public function changeCheckoutMarkup($field, $key, $args, $value): string // phpcs:ignore Inpsyde.CodeQuality.ArgumentTypeDeclaration -- mixed
    {
